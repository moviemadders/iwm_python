...
Run: cd backend && python populate_movies.py
"""
import asyncio
...
GENRES = ["Action", "Adventure", "Comedy", "Drama", "Horror", "Sci-Fi", "Thriller", "Romance", "Crime", "Fantasy", "Mystery", "War"]
DIRECTORS = ["Christopher Nolan", "Quentin Tarantino", "Martin Scorsese", "Steven Spielberg", "James Cameron", "Ridley Scott", "Peter Jackson", "George Lucas", "The Wachowskis", "David Fincher", "Francis Ford Coppola"]
    ...
    async with db_module.SessionLocal() as session:
        try:
            ...
            for i in range(200):
                ...
                check = await session.execute(select(Movie).where(Movie.title == title))
